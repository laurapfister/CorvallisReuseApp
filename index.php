<?php
	...
	*/
	...
	$app->patch('/reuse/:id', function($id) use($app){
		...
		$stmt = $mysqli->prepare("UPDATE reuse_businesses SET reuseName = ?, reuseAddress= ?, reuseCity= ?, reuseState= ?, reuseZip= ?, reusePhone= ?, reuseWeb= ?, reuseHours= ?, reuseLongitude= ?, reuseLatitude= ? WHERE repairId = ?");
